...
def main():
    print("🚀 TRAINING LTCUSDT (RANGE-BOUND) - REAL DATA - GPU")
    ...
    print(f"📊 LTCUSDT records: {len(ltc_df):,}")
    ...
    print(f"💾 LTCUSDT model saved in {training_time}")
